...
volatile enum sha_algos opt_algo = ALGO_X17;
int opt_n_threads = 0;
int gpu_threads = 1;
...
// get const array size (defined in XpsMiner.cpp)
int options_count()
{
	int n = 0;
...
#define YES "Share Accepted -_- !"
#define YAY "Block Solved -_- !!"
#define BOO "Share Rejected -_- !!"
...
int share_result(int result, int pooln, double sharediff, const char *reason)
{
	...
	if (!net_diff || sharediff < net_diff) {
		...
		:	(result ? "(" YAY ")" : "(" BOO ")");
		sprintf(solved, " solved %u blocks", p->solved_count);
	}


	applog(LOG_NOTICE, "%s%s",
		flag, solved);

	//applog(LOG_NOTICE, "Accepted %lu out of %lu Share(s), (%s), Total Speed: %s",
	//	p->accepted_count,
	//	p->accepted_count + p->rejected_count,
	//	suppl, s);

	applog(LOG_NOTICE, "Accepted %lu out of %lu Share(s), Total Speed: %s",
		p->accepted_count,
		p->accepted_count + p->rejected_count,
		s);
...
//	return true;
//}
static char* last_commit_prevhash =NULL;
...
static bool submit_upstream_work(CURL *curl, struct work *work)
{
	...
	if (pool->type & POOL_STRATUM) {
		...
		if (stratum.solo) {
			if (last_commit_prevhash) {
				char * tmp_last_commit_prevhash;
				tmp_last_commit_prevhash = bin2hex((const uchar*)(&work->data[1]), 20);
				if (strcmp((const char*)tmp_last_commit_prevhash, (const char*)last_commit_prevhash) == 0) {
					return false;
				}
			}
			...
			noncestr = bin2hex((const uchar*)(&work->data[18]), 8);

			sprintf(s, "{\"method\": \"mining.submit\", \"params\": ["
				"\"%s\",\"%s\"]}",
				noncestr, bin2hex((const uchar*)(&work->data[1]), 20));
			last_commit_prevhash = bin2hex((const uchar*)(&work->data[1]), 20);
		...
		sprintf(s, "{\"method\": \"mining.submit\", \"params\": ["
			"\"%s\", \"%s\"], \"id\":%u}",
			work->job_id + 8, &noncestr[work->xnonce2_len * 2], stratum.job.shares_count + 10);
...
bool get_work(struct thr_info *thr, struct work *work)
{
	...
	if (opt_benchmark) {
		...
		// bench test
#if 0
		memset(((uint8_t*)work->data) + 0, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 1, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 2, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 3, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 4, 0x01, sizeof(int8_t));        // 1
		memset(((uint8_t*)work->data) + 5, 0x0c, sizeof(int8_t));        // 2
		memset(((uint8_t*)work->data) + 6, 0x0c, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 7, 0x0c, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 8, 0x02, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 9, 0x05, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 10, 0x04, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 11, 0x02, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 12, 0x10, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 13, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 14, 0x10, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 15, 0x03, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 16, 0x0a, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 17, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 18, 0x04, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 19, 0x01, sizeof(int8_t));      // 16 
		memset(((uint8_t*)work->data) + 20, 0x01, sizeof(int8_t));      // 17
		memset(((uint8_t*)work->data) + 21, 0xc9, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 22, 0xbc, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 23, 0x02, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 24, 0xe7, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 25, 0x9e, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 26, 0xc9, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 27, 0x5a, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 28, 0x7b, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 29, 0xd4, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 30, 0xe1, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 31, 0x46, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 32, 0x15, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 33, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 34, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 35, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 36, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 37, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 38, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 39, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 40, 0x7b, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 41, 0xda, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 42, 0xae, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 43, 0xea, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 44, 0xc2, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 45, 0xf2, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 46, 0xd2, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 47, 0xda, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 48, 0x40, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 49, 0x04, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 50, 0xed, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 51, 0x3e, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 52, 0xe8, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 53, 0xb2, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 54, 0x9e, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 55, 0x4d, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 56, 0x3b, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 57, 0x38, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 58, 0x28, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 59, 0xde, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 60, 0x3e, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 61, 0x3d, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 62, 0xaa, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 63, 0x01, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 64, 0x68, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 65, 0x7c, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 66, 0x67, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 67, 0x8b, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 68, 0xcd, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 69, 0x4d, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 70, 0xad, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 71, 0x15, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 72, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 73, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 74, 0xb6, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 75, 0x20, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 76, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 77, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 78, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->data) + 79, 0x00, sizeof(int8_t));

		memset(((uint8_t*)work->target) + 0, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 1, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 2, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 3, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 4, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 5, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 6, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 7, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 8, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 9, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 10, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 11, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 12, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 13, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 14, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 15, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 16, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 17, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 18, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 19, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 20, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 21, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 22, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 23, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 24, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 25, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 26, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 27, 0xff, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 28, 0xff, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 29, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 30, 0x00, sizeof(int8_t));
		memset(((uint8_t*)work->target) + 31, 0x00, sizeof(int8_t));
#endif
...
static bool stratum_gen_work(struct stratum_ctx *sctx, struct work *work)
{
	...
	while (1) {
		if (!sctx->notify_init) {
			applog(LOG_WARNING, "stratum_gen_work: wait for the first job init");
			sleep(1);
		}
		else {
			break;
	...
	applog(LOG_INFO, "stratum_gen_work: job_id: %s", sctx->job.job_id);
	...
	/* Assemble block header */
	memset(work->data, 0, sizeof(work->data));
	if (opt_algo == ALGO_X17) {
		// first 4 bytes

		uint32_t version = 0x1;
		
		memcpy((unsigned char*)&work->data[0], (unsigned char*)&version, 4);
		
		// from 5th to 24th bytes

		memcpy((unsigned char*)&work->data[1], sctx->job.prevhash, 20);
		// from 25th to 68th bytes

		memset((unsigned char*)&work->data[6], 0x0, 44);
		// from69st to 72nd bytes

		uint32_t swapnbits = be32dec (sctx->job.nbits);
		memcpy((unsigned char*)&work->data[17], (unsigned char*)&swapnbits, 4);
		// from 73rd to 76th bytes
		// enonce

		memcpy((unsigned char*)&work->data[18], work->xnonce2, work->xnonce2_len);
		// get rand
		...
		t = time(NULL);
		srand(t);
		int rand_value = rand() & ((1 << ((4 - work->xnonce2_len) * 8)) - 1);

		//unsigned int rand_value = work->data[1];
		memcpy(((unsigned char*)&work->data[18]) + work->xnonce2_len, (unsigned char*)&rand_value, 4 - work->xnonce2_len);
	}
	else {
		applog(LOG_WARNING, "stratum_gen_work: opt_algo is not X17");
		return false;
	}
	if (sctx->solo) {
		calc_network_diff(work);
		sctx->job.diff = net_diff;
	}
	else {
...
static void *miner_thread(void *userdata)
{
	...
	while (!abort_flag) {
		...
		uint64_t max64, minmax = 0x10000000;
		...
		/*while (!g_work.job_id) {
			applog(LOG_INFO, "wait for new job");
...
int main(int argc, char *argv[])
{
	...
	printf("*** XpsMiner " PACKAGE_VERSION " for nVidia GPUs by tpruvot@github ***\n");
	printf("***       Modified by Xps Community Team       ***\n");
	if (!opt_quiet) {
